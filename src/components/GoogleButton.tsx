...
const GoogleButton = () => {
  ...
  return (
    <motion.button
      ...
      disabled={isLoading}
      className="group relative w-full overflow-hidden rounded-xl bg-card border border-border p-4 transition-all duration-300 hover:border-primary/50 disabled:opacity-50 disabled:cursor-not-allowed"
